...
def main():
    ...
    for episode in range(EPISODE):
        ...
        task = tg.MstarTask(metatrain_character_folders, CLASS_NUM, SAMPLE_NUM_PER_CLASS, BATCH_NUM_PER_CLASS)
        ...
        relation_pairs = torch.cat((sample_features_ext,batch_features_ext),2).view(-1,FEATURE_DIM*2,sample_features.size(3),sample_features.size(3))
        ...
        if (episode+1)%1000 == 0:
            ...
            if test_accuracy > last_accuracy:
                ...
                # save networks
                torch.save(feature_encoder.state_dict(),str("./models/mstar_feature_encoder_" + str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl"))
                torch.save(relation_network.state_dict(),str("./models/mstar_relation_network_"+ str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl"))
